...
//        System.err.println("Usage:   java LDAPAuthenticator <host Name> <login dn> <password>");
//        System.err.println("Example: java LDAPAuthenticator Acme.com \"cn=admin,o=Acme\" secret");
...
//            boolean correct = conn.compare( dn, attr );
//
//            System.out.println( correct ? "The password is correct.":"The password is incorrect.\n");

//            String userDN = "uid=gpedrosa,ou=People,dc=digmap,dc=eu";
//            String pass = "100coelhos.";
//
//            if ( GetBindInfo( conn, userDN, pass ) )
//                System.out.println("    User '" + dn + "' can login now");
//            else
//                System.out.println("    User '"+dn + "' can not login now");
